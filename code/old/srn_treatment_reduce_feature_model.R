...
#Load needed data
test_data <- read.csv("data/process/tables/srn_treatment_test_tune_data.csv", header = TRUE)
lesion_imp_vars <- read.csv("data/process/tables/srn_treatment_imp_vars_summary.csv", header = T, stringsAsFactors = F) %>% 
  rename(variable = Variable)
mda_summary <- read.csv("data/process/tables/srn_treatment_top_vars_MDA_Summary.csv", header = T, stringsAsFactors = F)
...
save.image("exploratory/srn_treatment_reduced_RF_model_Imp_OTU.RData")
