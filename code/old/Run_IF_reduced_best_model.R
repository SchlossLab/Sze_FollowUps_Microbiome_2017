...
test_data <- read.csv("data/process/tables/reduced_IF_test_tune_data.csv", header = TRUE)
split_data_results <- read.csv("data/process/tables/reduced_IF_ROC_model_summary.csv", header = TRUE, stringsAsFactors = F)
test_data_roc <- read.csv("data/process/tables/reduced_IF_test_data_roc.csv", header = TRUE, stringsAsFactors = F)
...
write.csv(probability_data_table, 
          "data/process/tables/reduced_IF_follow_up_probability_summary.csv", row.names = F)
