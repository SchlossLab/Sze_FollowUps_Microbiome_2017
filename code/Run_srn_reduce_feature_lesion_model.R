...
#Load needed data
test_data <- read.csv("data/process/tables/srn_test_tune_data.csv", header = TRUE)
lesion_imp_vars <- read.csv("data/process/tables/srn_rf_wCV_imp_vars_summary.csv", header = T, stringsAsFactors = F)
...
save.image("exploratory/srn_RF_reduced_features_model_setup.RData")
