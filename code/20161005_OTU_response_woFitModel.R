### Investigate Imp OTU variables at initial and follow up without Fit model
...
ggsave(file = "results/figures/OTUselect_response_SRNNoFitModel.tiff", SRNplot, width=10, height = 20, dpi = 300)
...
ggsave(file = "results/figures/OTUselect_response_LesionNoFitModel.tiff", SRNplot, width=10, height = 20, dpi = 300)
