...
test_data <- read.csv("data/process/tables/srn_full_test_data.csv", row.names = 1, header = TRUE)
split_data_results <- read.csv("data/process/tables/srn_ROC_model_summary.csv", header = TRUE, stringsAsFactors = F)
test_data_roc <- read.csv("data/process/tables/srn_test_data_roc.csv", header = TRUE, stringsAsFactors = F)
