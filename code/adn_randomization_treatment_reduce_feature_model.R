...
test_data_imps <- select(test_data, lesion, one_of(vars_to_keep$otu))
...
write.csv(final_results, "data/process/tables/adn_rand_treat_reduced_summary.csv", row.names = F)
