...
%DIF DEL submission/manuscript.tex      Sat Jul 22 09:51:59 2017
%DIF ADD submission/manuscript_R1.tex   Mon Aug 14 13:38:58 2017
\usepackage{lmodern}
...
\section{\DIFdelbegin \DIFdel{The effect }\DIFdelend \DIFaddbegin \DIFadd{Normalization }\DIFaddend of \DIFdelbegin \DIFdel{treatment on }\DIFdelend the microbiota \DIFdelbegin \DIFdel{of }\DIFdelend \DIFaddbegin \DIFadd{in }\DIFaddend patients \DIFdelbegin \DIFdel{diagnosed
with }\DIFdelend \DIFaddbegin \DIFadd{after treatment for
}\DIFaddend colonic
lesions}\DIFdelbegin %DIFDELCMD < \label{the-effect-of-treatment-on-the-microbiota-of-patients-diagnosed-with-colonic-lesions}
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \label{normalization-of-the-microbiota-in-patients-after-treatment-for-colonic-lesions}
\DIFaddend 
...
\textbf{Results.} There were \DIFdelbegin \DIFdel{large }\DIFdelend \DIFaddbegin \DIFadd{small }\DIFaddend changes to the bacterial \DIFdelbegin \DIFdel{communities
associated with treatment across the three groups}\DIFdelend \DIFaddbegin \DIFadd{community
associated with adenoma or advanced adenoma and large changes associated
with carcinoma}\DIFaddend . The communities from patients with carcinomas changed
significantly more than those with adenoma following treatment (P-value
\textless{} 0.001). \DIFdelbegin \DIFdel{There was no
...
carcinoma (P-value \textgreater{} 0.05). }\DIFdelend Although treatment was associated with intrapersonal
changes, the change in the abundance of individual OTUs \DIFaddbegin \DIFadd{in response }\DIFaddend to
...
learning algorithm to identify groups of OTUs that \DIFdelbegin \DIFdel{allowed us to
successfully distinguish between }\DIFdelend \DIFaddbegin \DIFadd{could be used to
classify }\DIFaddend pre and post-treatment samples for each of the diagnosis
groups. Although the three models \DIFdelbegin \DIFdel{successfully
differentiated }\DIFdelend \DIFaddbegin \DIFadd{could differentiate }\DIFaddend between the pre
and post-treatment samples, there was little overlap between the OTUs
that were indicative of \DIFdelbegin \DIFdel{treatment. Next,
}\DIFdelend \DIFaddbegin \DIFadd{each treatment. To determine whether individuals
who underwent treatment were more likely to have OTUs associated with
normal colons }\DIFaddend we used a larger cohort that contained individuals with
normal colons and those with adenomas, advanced adenomas, and
carcinomas\DIFdelbegin \DIFdel{to determine
whether individuals who underwent treatment were more likely to have
OTUs associated with normal colons}\DIFdelend . We again built Random Forest models and measured the change
in the positive probability of having one of the three diagnoses \DIFdelbegin \DIFdel{. Only }\DIFdelend \DIFaddbegin \DIFadd{to
assess whether the post-treatment samples received the same
classification as the pre-treatment samples. Samples from }\DIFaddend patients who
had carcinomas \DIFdelbegin \DIFdel{experienced a
significant decrease in positive probability of having a lesion }\DIFdelend \DIFaddbegin \DIFadd{changed towards a microbial milieu that resembles the
normal colon }\DIFaddend after treatment (P-value \textless{} 0.05)\DIFdelbegin \DIFdel{, indicating that the microbial
milieu of the colon more closely resembled that of a normal colon}\DIFdelend . Finally, we
\DIFdelbegin \DIFdel{tested whether the type of treatment impacted the microbiota
of those diagnosed with carcinomas and }\DIFdelend were unable to detect any significant differences in \DIFdelbegin \DIFdel{characteristics of
these communities between
}\DIFdelend \DIFaddbegin \DIFadd{the microbiota of
}\DIFaddend individuals treated with surgery alone and those treated with
...
biomarkers will \DIFaddbegin \DIFadd{eventually }\DIFaddend be validated that can be used to quantify the
risk of recurrence and the likelihood of survival. \DIFaddbegin \DIFadd{Although it was
...
\textbf{\DIFdelbegin \emph{\DIFdel{Treatment alters the bacterial community structure of
patients diagnosed with colonic lesions.}}%DIFAUXCMD
\DIFdelend \DIFaddbegin \emph{\DIFadd{Treatment for colonic lesions alters the bacterial
community structure}}\DIFaddend } Within our 67-person cohort we tested whether the
...
post-treatment samples {[}Table 1{]}. \DIFaddbegin \DIFadd{None of the individuals in this
study had any recorded antibiotic usage that was not associated with
surgical treatment of their respective lesion. }\DIFaddend The structure of the
...
\DIFdelbegin \DIFdel{post-treament }\DIFdelend \DIFaddbegin \DIFadd{post-treatment }\DIFaddend among the patients with carcinomas changed significantly
...
\textbf{\DIFdelbegin \emph{\DIFdel{The effects of treatment are not consistent across
treatment groups.}}%DIFAUXCMD
\DIFdelend \DIFaddbegin \emph{\DIFadd{The treatment of lesions are not consistent across
diagnosis groups.}}\DIFaddend } We used two approaches to identify those bacterial
...
statistical power of the test. \DIFdelbegin \DIFdel{To }\DIFdelend \DIFaddbegin \DIFadd{We attempted to }\DIFaddend overcome these problems
\DIFdelbegin \DIFdel{we developed
}\DIFdelend \DIFaddbegin \DIFadd{by using }\DIFaddend Random Forest models to identify collections of OTUs that would
...
would \DIFdelbegin \DIFdel{overfit
}\DIFdelend \DIFaddbegin \DIFadd{over-fit }\DIFaddend the data because of the relatively small number of
...
each model had little overlap with each other {[}Figure 2{]}. \DIFdelbegin \DIFdel{These results support
the earlier community-wide analysis where we observed that the }\DIFdelend \DIFaddbegin \DIFadd{Although
}\DIFaddend treatment had an impact on the overall community structure\DIFdelbegin \DIFdel{; however}\DIFdelend , the effect
...
surgical resection with chemotherapy and radiation (N=5). \DIFdelbegin \DIFdel{We focused on
...
improve our statistical power. We did not observe a }\DIFdelend \DIFaddbegin \DIFadd{Regardless of
treatment used there was no }\DIFaddend significant difference in the effect of
...
between \DIFdelbegin \DIFdel{the two }\DIFdelend \DIFaddbegin \DIFadd{any of the }\DIFaddend treatment groups (P-value = 0.532). Due to the
...
\DIFaddbegin \DIFadd{Some of these changes, specifically for adenoma, may be due to normal
temporal variation, however, those with advanced adenoma and carcinoma
clearly had large microbiota changes. }\DIFaddend After treatment, the microbiota of
...
not only predict the presence of lesions but to \DIFaddbegin \DIFadd{also }\DIFaddend assess the risk of
recurrence \DIFaddbegin \DIFadd{due to these changes in the microbiota}\DIFaddend .
...
(344 (266 - 408) days). \DIFaddbegin \DIFadd{We also found no difference in the community
...
\DIFdelbegin \DIFdel{The most exciting future direction from the current study }\DIFdelend \DIFaddbegin \DIFadd{We were surprised by the lack of a consistent signal that was associated
...
patients. One of the most exciting of these future directions }\DIFaddend is the
possibility that markers within the microbiota could be used to
\DIFaddbegin \DIFadd{potentially }\DIFaddend evaluate the effect of treatment and predict recurrence for
those diagnosed with carcinoma. If such an approach is effective, it
might be possible to target the microbiota as part of adjuvant therapy\DIFaddbegin \DIFadd{,
if the biomarkers identified play a key role in the disease process}\DIFaddend . Our
...
}\DIFdelend \DIFaddbegin \DIFadd{samples were stored on ice for at least 24h before freezing. Although we
...
methodology. Study }\DIFaddend exclusion involved those who had already undergone
...
\DIFaddbegin \textbf{\emph{\DIFadd{Treatment.}}} \DIFadd{For this study treatment refers specifically
...
adenoma were not treated surgically }{[}\DIFadd{Table 1}{]} \DIFadd{but rather via
...
}{[}\DIFadd{Table 1}{]}\DIFadd{. If an individual was treated with radiation they were
also always treated with chemotherapy. Radiation therapy generally used
18 mV photons for treatment.
}

\DIFaddend \textbf{\emph{16S rRNA Gene Sequencing.}} Sequencing was completed as
...
\DIFdelbegin \DIFdel{Similarily}\DIFdelend \DIFaddbegin \DIFadd{Similarly}\DIFaddend , the Random Forest {[}33{]} algorithm was also used to create
the three models used to classify normal versus diagnosis. \DIFaddbegin \DIFadd{These samples
...
pre-treatment samples only. }\DIFaddend The total number of individuals in the
...
(pre-treatment carcinoma (\DIFdelbegin \DIFdel{carinoma }\DIFdelend \DIFaddbegin \DIFadd{carcinoma }\DIFaddend n = 26 and disease free n = 0)
...
the \DIFdelbegin \DIFdel{probabilites }\DIFdelend \DIFaddbegin \DIFadd{probabilities }\DIFaddend that the sample was a pre-treatment sample. The
...
\DIFaddbegin \DIFadd{Comparisons between different treatment for lesions utilized a Kruskal
Wallis test. }\DIFaddend Where multiple comparison testing was appropriate, a
...
\DIFdelbegin \textbf{\DIFdel{Figure 1: General differences between adenoma, advanced adenoma,
and carcinoma groups after treatment.}} %DIFAUXCMD
\DIFdel{A) Thetayc distance from pre
...
advanced adenoma, and carcinoma.}} %DIFAUXCMD
...
adenoma, and carcinoma.}} %DIFAUXCMD
...
advanced adenoma, or carcinoma.}} %DIFAUXCMD
...
%DIFDELCMD < \toprule
%DIFDELCMD < & %%%
\DIFdel{Adenoma }%DIFDELCMD < & %%%
\DIFdel{Advanced Adenoma }%DIFDELCMD < & %%%
\DIFdel{Carcinoma}%DIFDELCMD < \tabularnewline
%DIFDELCMD < \midrule
%DIFDELCMD < \endhead
%DIFDELCMD < %%%
\DIFdel{n }%DIFDELCMD < & %%%
\DIFdel{22 }%DIFDELCMD < & %%%
\DIFdel{19 }%DIFDELCMD < & %%%
\DIFdel{26}%DIFDELCMD < \tabularnewline
%DIFDELCMD < %%%
\DIFdel{Age (Mean ± SD) }%DIFDELCMD < & %%%
\DIFdel{61.68 ± 7.2 }%DIFDELCMD < & %%%
\DIFdel{63.11 ± 10.9 }%DIFDELCMD < & %%%
\DIFdel{61.65 ±
12.9}%DIFDELCMD < \tabularnewline
%DIFDELCMD < %%%
\DIFdel{Sex (}%DIFDELCMD < \%%%%
\DIFdel{F) }%DIFDELCMD < & %%%
\DIFdel{36.36 }%DIFDELCMD < & %%%
\DIFdel{36.84 }%DIFDELCMD < & %%%
\DIFdel{42.31}%DIFDELCMD < \tabularnewline
%DIFDELCMD < %%%
\DIFdel{BMI (Mean ± SD) }%DIFDELCMD < & %%%
\DIFdel{26.86 ± 3.9 }%DIFDELCMD < & %%%
\DIFdel{25.81 ± 4.7 }%DIFDELCMD < & %%%
\DIFdel{28.63 ± 7.2}%DIFDELCMD < \tabularnewline
%DIFDELCMD < %%%
\DIFdel{Caucasian (}%DIFDELCMD < \%%%%
\DIFdel{) }%DIFDELCMD < & %%%
\DIFdel{95.45 }%DIFDELCMD < & %%%
\DIFdel{84.21 }%DIFDELCMD < & %%%
\DIFdel{96.15}%DIFDELCMD < \tabularnewline
%DIFDELCMD < %%%
\DIFdel{Days Between Colonoscopy (Mean ± SD) }%DIFDELCMD < & %%%
\DIFdel{255.41 ± 42 }%DIFDELCMD < & %%%
\DIFdel{250.16 ± 41 }%DIFDELCMD < &
%DIFDELCMD < %%%
\DIFdel{350.85 ± 102}%DIFDELCMD < \tabularnewline
...
%DIFDELCMD < \begin{longtable}[]{@{}lcccc@{}}
%DIFDELCMD < \toprule
%DIFDELCMD < & %%%
\DIFdel{Normal }%DIFDELCMD < & %%%
\DIFdel{Adenoma }%DIFDELCMD < & %%%
\DIFdel{Advanced Adenoma }%DIFDELCMD < & %%%
\DIFdel{Carcinoma}%DIFDELCMD < \tabularnewline
%DIFDELCMD < \midrule
...
%DIFDELCMD < %%%
\DIFdel{n }%DIFDELCMD < & %%%
\DIFdel{172 }%DIFDELCMD < & %%%
\DIFdel{67 }%DIFDELCMD < & %%%
\DIFdel{90 }%DIFDELCMD < & %%%
\DIFdel{94}%DIFDELCMD < \tabularnewline
%DIFDELCMD < %%%
\DIFdel{Age (Mean ± SD) }%DIFDELCMD < & %%%
\DIFdel{54.29 ± 9.9 }%DIFDELCMD < & %%%
\DIFdel{63.01 ± 13.1 }%DIFDELCMD < & %%%
\DIFdel{64.07 ± 11.3 }%DIFDELCMD < & %%%
\DIFdel{64.37 ±
12.9}%DIFDELCMD < \tabularnewline
%DIFDELCMD < %%%
\DIFdel{Sex (}%DIFDELCMD < \%%%%
\DIFdel{F) }%DIFDELCMD < & %%%
\DIFdel{64.53 }%DIFDELCMD < & %%%
\DIFdel{46.27 }%DIFDELCMD < & %%%
\DIFdel{37.78 }%DIFDELCMD < & %%%
\DIFdel{43.62}%DIFDELCMD < \tabularnewline
%DIFDELCMD < %%%
\DIFdel{BMI (Mean ± SD) }%DIFDELCMD < & %%%
\DIFdel{26.97 ± 5.3 }%DIFDELCMD < & %%%
\DIFdel{25.69 ± 4.8 }%DIFDELCMD < & %%%
\DIFdel{26.66 ± 4.9 }%DIFDELCMD < & %%%
\DIFdel{29.27 ±
6.7}%DIFDELCMD < \tabularnewline
%DIFDELCMD < %%%
\DIFdel{Caucasian (}%DIFDELCMD < \%%%%
\DIFdel{) }%DIFDELCMD < & %%%
\DIFdel{87.79 }%DIFDELCMD < & %%%
\DIFdel{92.54 }%DIFDELCMD < & %%%
\DIFdel{92.22 }%DIFDELCMD < & %%%
\DIFdel{94.68}%DIFDELCMD < \tabularnewline
%DIFDELCMD < \bottomrule
%DIFDELCMD < \end{longtable}
%DIFDELCMD < 
...
test set data and the dark green line represents the model using 100}%DIFDELCMD < \%
%DIFDELCMD < %%%
...
the dark yellow line represents the model using 100}%DIFDELCMD < \% %%%
...
represents the model using 100}%DIFDELCMD < \% %%%
...
adenoma, and carcinoma models.}} %DIFAUXCMD
...
\DIFdelend \DIFaddbegin \subsection{\DIFadd{References}}\DIFaddend \label{references}
\DIFdelbegin \addcontentsline{toc}{subsection}{\DIFdel{References}}
%DIFAUXCMD
\DIFdelend 
...
\textbf{\DIFadd{Table 1: Demographic data of patients in the pre and
post-treatment cohort}}

\begin{longtable}[]{@{}lccc@{}}
\toprule
& \DIFadd{Adenoma }& \DIFadd{Advanced Adenoma }& \DIFadd{Carcinoma}\tabularnewline
\midrule
\endhead
\DIFadd{n }& \DIFadd{22 }& \DIFadd{19 }& \DIFadd{26}\tabularnewline
\DIFadd{Age (Mean ± SD) }& \DIFadd{61.68 ± 7.2 }& \DIFadd{63.11 ± 10.9 }& \DIFadd{61.65 ±
12.9}\tabularnewline
\DIFadd{Sex (}\%\DIFadd{F) }& \DIFadd{36.36 }& \DIFadd{36.84 }& \DIFadd{42.31}\tabularnewline
\DIFadd{BMI (Mean ± SD) }& \DIFadd{26.86 ± 3.9 }& \DIFadd{25.81 ± 4.7 }& \DIFadd{28.63 ± 7.2}\tabularnewline
\DIFadd{Caucasian (}\%\DIFadd{) }& \DIFadd{95.45 }& \DIFadd{84.21 }& \DIFadd{96.15}\tabularnewline
\DIFadd{Days Between Colonoscopy (Mean ± SD) }& \DIFadd{255.41 ± 42 }& \DIFadd{250.16 ± 41 }&
\DIFadd{350.85 ± 102}\tabularnewline
\DIFadd{Surgery Only }& \DIFadd{4 }& \DIFadd{4 }& \DIFadd{12}\tabularnewline
\DIFadd{Surgery }\& \DIFadd{Chemotherapy }& \DIFadd{0 }& \DIFadd{0 }& \DIFadd{9}\tabularnewline
\DIFadd{Surgery, Chemotherapy, }\& \DIFadd{Radiation }& \DIFadd{0 }& \DIFadd{0 }& \DIFadd{5}\tabularnewline
\bottomrule
\end{longtable}

\newpage

\textbf{\DIFadd{Table 2: Demographic data of training cohort}}

\begin{longtable}[]{@{}lcccc@{}}
\toprule
& \DIFadd{Normal }& \DIFadd{Adenoma }& \DIFadd{Advanced Adenoma }& \DIFadd{Carcinoma}\tabularnewline
\midrule
\endhead
\DIFadd{n }& \DIFadd{172 }& \DIFadd{67 }& \DIFadd{90 }& \DIFadd{94}\tabularnewline
\DIFadd{Age (Mean ± SD) }& \DIFadd{54.29 ± 9.9 }& \DIFadd{63.01 ± 13.1 }& \DIFadd{64.07 ± 11.3 }& \DIFadd{64.37 ±
12.9}\tabularnewline
\DIFadd{Sex (}\%\DIFadd{F) }& \DIFadd{64.53 }& \DIFadd{46.27 }& \DIFadd{37.78 }& \DIFadd{43.62}\tabularnewline
\DIFadd{BMI (Mean ± SD) }& \DIFadd{26.97 ± 5.3 }& \DIFadd{25.69 ± 4.8 }& \DIFadd{26.66 ± 4.9 }& \DIFadd{29.27 ±
6.7}\tabularnewline
\DIFadd{Caucasian (}\%\DIFadd{) }& \DIFadd{87.79 }& \DIFadd{92.54 }& \DIFadd{92.22 }& \DIFadd{94.68}\tabularnewline
\bottomrule
\end{longtable}

\newpage

\textbf{\DIFadd{Figure 1: General differences between adenoma, advanced adenoma,
and carcinoma groups after treatment.}} \DIFadd{A) \(\theta\)\textsubscript{YC}
...
\textbf{\DIFadd{Figure 2: The 10 OTUs used to classify treatment for adenoma,
advanced adenoma, and carcinoma.}} \DIFadd{A) Adenoma OTUs. B) Advanced Adenoma
...
\textbf{\DIFadd{Figure 3: OTUs common to those models used to differentiate
between patients with normal colons and those with adenoma, advanced
adenoma, and carcinoma.}} \DIFadd{A) Venn diagram showing the OTU overlap between
each model. B) For each common OTU the lowest taxonomic identification
and importance rank for each model run is shown.
}

\textbf{\DIFadd{Figure 4: Treatment response based on models built for adenoma,
advanced adenoma, or carcinoma.}} \DIFadd{A) Positive probability change from
initial to follow up sample in those with adenoma. B) Positive
probability change from initial to follow up sample in those with
advanced adenoma. C) Positive probability change from initial to follow
up sample in those with carcinoma.
...
\textbf{\DIFadd{Figure S1: ROC curves of the adenoma, advanced adenoma, and
carcinoma models.}} \DIFadd{A) Adenoma ROC curve: The light green shaded areas
represent the range of values of a 100 different 80/20 splits of the
test set data and the dark green line represents the model using 100}\%
\DIFadd{of the data set and what was used for subsequent classification. B)
Advanced Adenoma ROC curve: The light yellow shaded areas represent the
range of values of a 100 different 80/20 splits of the test set data and
the dark yellow line represents the model using 100}\% \DIFadd{of the data set
and what was used for subsequent classification. C) Carcinoma ROC curve:
The light red shaded areas represent the range of values of a 100
different 80/20 splits of the test set data and the dark red line
represents the model using 100}\% \DIFadd{of the data set and what was used for
subsequent classification.
}

\textbf{\DIFadd{Figure S2: Summary of important OTUs for the adenoma, advanced
adenoma, and carcinoma models.}} \DIFadd{A) MDA of the most important variables
in the adenoma model. The dark green point represents the mean and the
lighter green points are the value of each of the 100 different runs. B)
Summary of Important Variables in the advanced adenoma model. MDA of the
most important variables in the SRN model. The dark yellow point
...
\textbf{\DIFadd{Figure S3: Pre and post-treatment relative abundance of CRC
associated OTUs within the carcinoma model.}}
