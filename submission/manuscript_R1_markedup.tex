...
%DIF ADD submission/manuscript_R1.tex   Mon Aug 14 12:16:01 2017
\usepackage{lmodern}
...
classification as the pre-treament samples. Samples from }\DIFaddend patients who
...
post-treatment samples from patientes with adenoma and advanced adenoma,
...
would overfit the data because of the relatively small number of
...
in the formation of adnomas and carcinomas or it could be due to
...
adenoma were not treated surigically }{[}\DIFadd{Table 1}{]} \DIFadd{but rather via
...
chermotherapy, and radiation. The type of chemotherapy used for patients
