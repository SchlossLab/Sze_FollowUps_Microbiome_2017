...
lesion_top10_varsMDA <- read.csv('../results/tables/reduced_lesion_model_top_vars_MDA_Summary.csv', header = T, stringsAsFactors = F)
IF_top10_varsMDA <- read.csv('../results/tables/reduced_IF_model_top_vars_MDA_Summary.csv', header = T, stringsAsFactors = F)
