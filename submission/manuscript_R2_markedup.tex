...
%DIF ADD submission/manuscript_R2.tex   Wed Sep 13 12:50:31 2017
\usepackage{lmodern}
...
\DIFdelbegin \DIFdel{mtry was 2. }\DIFdelend \DIFaddbegin \DIFadd{mtrys were 2 (n = 16), 37 (n = 44), and 707 (n = 40) for adenoma. For
advanced adenoma 2 (n = 33), 37 (n = 50), and 696 (n = 17). For
carcinoma 36 (n = 96) and 649 (n = 4). }\DIFaddend The hyper-parameter, mtry,
defines the number of variables to investigate at each split before a
new division of the data was created with the Random Forest model \DIFdelbegin %DIFDELCMD < {[}%%%
\DIFdel{33}%DIFDELCMD < {]}%%%
\DIFdel{.
