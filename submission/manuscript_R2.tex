...
groups. Although the adenoma and carcinoma models could reliably
differentiate between the pre and post-treatment samples (P-value
\textless{} 0.001), the advanced-adenoma model could not (P-value =
0.61). Furthermore, there was little overlap between the OTUs that were
...
treatment (P-value \textless{} 0.001). Finally, we were unable to detect
...
Helsinki Declaration. The original protocol for the study did not
