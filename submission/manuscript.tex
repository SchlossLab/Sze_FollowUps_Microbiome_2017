...
significantly different in the pre and post-treatment groups (P-value NA
0.05). It is likely that high inter-individual variation and the
...
probabilities increased (382 \(\pm\) 116 days) or decreased (341 \(\pm\)
98 days) (Wilcoxon Test; P-value = 0.56). Finally, it is possible that
these patients may not have responded to treatment as well as the other
20 patients diagnosed with carcinoma and so the microbiota may not have
...
appropriate, a Benjamini-Hochberg (BH) correction was applied {[}35{]}
...
Post-Treatment Sample (Mean ± SD) & 255.41 ± 42 & 250.16 ± 41 & 350.85 ±
102\tabularnewline
\bottomrule
\end{longtable}
