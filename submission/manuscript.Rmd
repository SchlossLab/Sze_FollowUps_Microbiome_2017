...
This study builds upon previous work that demonstrated a role for the microbiota in tumorigenesis and that the microbiome contains biomarkers to diagnosis colonic lesions [ADD REFERENCES FOR CAUSATION;  @yu_metagenomic_2017; @baxter_microbiota-based_2016; @zeller_potential_2014; @zackular_human_2014; @warren_co-occurrence_2013]. Our study focused on comparing the microbiome of patients diagnosed with adenoma, advanced adenoma, and carcinoma before and after treatment. For all three groups of patients we observed changes in their microbiota. The microbiota of patients diagnosed with carcinoma changed significant more than the other groups. This change resulted in communities that more closely resembled those of patients with normal colons.

* Does treatment affect the colonic microbiota in a predictable manner? For those with carcinoma

* Does the treatment alter the community to more closely resemble that of individuals with normal colons? For those with carcinoma.

* Heterogeneity of the population (common problem for all microbiome studies) made it impossible to identify speicfi microbiota that changed with treatment; however, RF made it possible to identify consortia of microbiota that were associated with treatment and recovery.

* End.

Although there were differences for genera associated with specific bacterium linked with CRC [Figure S3], most of the important OTUs taxonomically classified to commensal bacteria [Figure S3]. Although these changes may be subtle, due to the lack of significant differences in the bacterial community pre- and post-treatment in adenoma and advanced adenoma [Figure 1]; they support the hypothesis that the first members of the community to change and potentially stay changed even after treatment are those that are commensal bacteria.


Here we show that the microbiome changes towards normal after treatment for carcinoma
