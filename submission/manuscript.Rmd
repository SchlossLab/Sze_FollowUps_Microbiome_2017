...
test_cohort <- good_metaf %>% select(Dx_Bin, dx, Age, Gender, BMI, White, time, Surgery, chemo_received, radiation_received)

t2 <- as.data.frame(matrix(nrow = 9, ncol = 3, 
                           dimnames = 
                             list(rown = c("Dx_Bin", "Age", "Gender_f", "BMI", "White", "post_time",  
                                           "Surgery_only", "Surg_Chemo", "Surg_Chemo_Radiation"), 
