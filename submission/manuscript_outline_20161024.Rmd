...
IF_model_wilcox_paired_summary <- read.csv('../results/tables/all_models_wilcox_paired_pvalue_summary.csv', header = T)
...
bacterial microbiome; colorectal cancer; polyps      
