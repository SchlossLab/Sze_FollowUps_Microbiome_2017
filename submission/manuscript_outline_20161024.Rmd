...
The test set AUC range for the full and reduced lesion model were similar to that reported for the training set AUC ranges and the ROC curve ranges overlap each other [Figure 3a].  The ROC curve for the final lesion model used was within the range of both the full and reduced lesion model [Figure 3a].  Interestingly, the test set AUC range for the initial sample model performed much better then the training set AUCs.  Both the full and reduced initial sample models overlapped with each other [Figure 3b] but there was a marked decrease in the ROC curve for the final model used.  
