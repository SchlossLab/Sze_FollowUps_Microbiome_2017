...
The test set AUC range for the full and reduced lesion model were similar to that reported for the training set AUC ranges and the ROC curve ranges overlap each other [Figure 3a].  The ROC curve for the final lesion model used falls within the range of both the full and reduced lesion model [Figure 3a]. 
