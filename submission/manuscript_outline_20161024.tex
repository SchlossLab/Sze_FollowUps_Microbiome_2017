...
between initial and follow up (P-value = \texttt{0.002}) but not for the
adenoma group (P-value = \texttt{0.997}) {[}Figure 2{]}. When all follow
up samples were compared to each other there was no significant overall
difference between them (P-value = \texttt{0.085}). There was no
