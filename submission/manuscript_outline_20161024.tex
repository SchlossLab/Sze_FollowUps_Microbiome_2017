...
can be used as a biomarker for CRC. In this study, we used a
microbiome-based model that classified individuals as having an adenoma
or carcinoma to assess whether the probability of having one of these
lesions changed after surgical treatment. We also characterized the
change in the gut microbiota before and after the surgical treatment.
...
for Peptostreptococcus assacharolytica (P-value = 0.0183) and
Porphyromonas stomatis (P-value = 0.0154) whereas there were no
...
OTUs classfied as Peptostreptococcus assacharolytica (P-value = 0.0183)
and Porphyromonas stomatis (P-value = 0.0154). B) Adenoma initial and
